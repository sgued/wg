...
- **AI tools must not replace human-to-human contributons.** AI generated prose must not be used in code comments, commit messages, GitHub issues or pull requests descriptions and comments. AI generated prose tend to require time and energy to sort through, do not expect fellow contributors to do it for you. You must understand what you submit, so explaining it in your own words proves that you do, while AI prose raises doubts.
